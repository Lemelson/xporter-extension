...
(function () {
  ...
  const TRACKED = ['Followers', 'Following', 'BlueVerifiedFollowers', 'UserTweets', 'UserOriginalsTimeline', 'UserTweetsAndReplies', 'Bookmarks', 'TweetResultsByRestIds', 'UserByScreenName', 'AboutAccountQuery', 'SearchTimeline'];
