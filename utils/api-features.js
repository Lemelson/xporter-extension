...
// Features for the signed-in viewer's Bookmarks timeline. Keep this separate
// from UserTweets: X ships Bookmarks as its own GraphQL operation and can
// rotate the accepted feature set independently.
...
// X's client hydrates several tweet IDs with one bulk request. Reuse the
// Bookmarks tweet surface and explicitly ask for available Article plain text
// so replied-to and quoted Articles remain self-contained in exports.
const TWEET_RESULTS_FEATURES = {
    ...BOOKMARKS_FEATURES
};

const TWEET_RESULTS_FIELD_TOGGLES = {
